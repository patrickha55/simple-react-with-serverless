export const config = {
    ...
    "IMAGES_TABLE": process.env.IMAGES_TABLE,
    "IMAGE_ID_INDEX": process.env.IMAGE_ID_INDEX,
    ...
    "AUTH_0_SECRET_ID": process.env.AUTH_0_SECRET_ID,
    "AUTH_0_SECRET_FIELD": process.env.AUTH_0_SECRET_FIELD,
}